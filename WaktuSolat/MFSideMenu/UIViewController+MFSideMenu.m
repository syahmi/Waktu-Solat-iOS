...
- (UIBarButtonItem *)menuBarButtonItem {
    ...
    [sidebarButton addTarget:self action:@selector(toggleSideMenuPressed:) forControlEvents:UIControlEventTouchUpInside];
    [sidebarButton setImage:[UIImage imageNamed:@"sidebarButton.png"] forState:UIControlStateNormal];
    
    return [[UIBarButtonItem alloc] initWithCustomView:sidebarButton];
}
